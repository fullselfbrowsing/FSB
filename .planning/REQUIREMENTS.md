...
- [ ] **LSDK-15..18 (TBD):** Remaining provider adapter extensions -- Gemini full custom (Plan 04-02), xAI / OpenRouter / LM Studio thin wrappers around `createOpenAICompatibleProvider` (Plan 04-03), public-surface re-exports + INV-03 parity smoke (Plan 04-04), FSB-side surface-presence smoke + ceremony closure (Plan 04-05).
