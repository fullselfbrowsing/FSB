...
- [ ] **CI-01**: The `lint:i18n` ignore-pattern for `src/app/pages/stats/**` is removed only after RESYNC-02 is verified complete.
...
- [ ] **CI-05**: The dashboard page's `lint:i18n` exclusion is documented as a permanent, intentional architectural boundary (authenticated app surface, not marketing content) rather than left as open deferred debt.
