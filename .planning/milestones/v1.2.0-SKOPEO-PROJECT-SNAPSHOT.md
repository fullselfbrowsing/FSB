...
(Milestone v1.2.0 Skopeo -- started 2026-07-14. Atomic requirements are approved in `.planning/milestones/v1.2.0-SKOPEO-REQUIREMENTS.md`; the broader milestone hypotheses below remain active until their owning phases are verified.)
