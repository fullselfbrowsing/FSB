...
key-files:
  created: [.planning/milestones/v1.2.0-SKOPEO-phases/52-on-demand-hud-lifecycle-primitive-shell/52-12-SUMMARY.md]
...
- `.planning/milestones/v1.2.0-SKOPEO-phases/52-on-demand-hud-lifecycle-primitive-shell/52-12-SUMMARY.md` — Records the WR-09 closure, matrices, verification, and deferred live-UAT boundary.
- `.planning/milestones/v1.2.0-SKOPEO-ROADMAP.md` — Records all 12 Phase 52 plans executed.
- `.planning/milestones/v1.2.0-SKOPEO-STATE-SNAPSHOT.md` — Records ready-for-verification state, decisions, metrics, and session continuity.
