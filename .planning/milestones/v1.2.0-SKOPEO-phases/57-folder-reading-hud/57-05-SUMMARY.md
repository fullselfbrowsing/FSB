...
key-files:
  created:
    - .planning/milestones/v1.2.0-SKOPEO-phases/57-folder-reading-hud/57-05-SUMMARY.md
...
- `.planning/milestones/v1.2.0-SKOPEO-phases/57-folder-reading-hud/57-HUMAN-UAT.md` - Records four sanitized manual checks as unapproved and human-needed.
- `.planning/milestones/v1.2.0-SKOPEO-phases/57-folder-reading-hud/57-VALIDATION.md` - Records Wave 0 completion, automated results, and the remaining human evidence boundary.
