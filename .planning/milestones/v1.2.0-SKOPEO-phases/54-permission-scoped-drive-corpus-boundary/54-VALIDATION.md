...
- [x] `.planning/milestones/v1.2.0-SKOPEO-phases/54-permission-scoped-drive-corpus-boundary/54-HUMAN-UAT.md` — metadata-only live ledger template with no Drive IDs, filenames, content, snippets, tokens, or raw errors.
