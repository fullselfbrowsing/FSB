...
**Plans**: 8 plans
- [ ] 61-01: Freeze exact agent routing, delegated mode, read-only preflight, one-use consent, and provider-local trust.
- [ ] 61-02: Build the bounded write-before-fanout event ledger and sole delegated lifecycle controller.
- [ ] 61-03: Serialize async bridge observers, add acknowledged active-delegation heartbeat, and pin Chrome 116/no-native authority.
- [ ] 61-04: Correlate server delegation ids with extension agents and add sealed complete mapped-tab hold leases.
- [ ] 61-05: Add supervisor hold/resume/status plus generation-backed restart-loss evidence.
