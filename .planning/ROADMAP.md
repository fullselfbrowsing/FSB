...
**Plans:** 3 plans across 2 waves (Wave 0 SW-side producer + Wave 0 smoke scaffold; Wave 1 agent-loop emission + smoke fill; Wave 1 ceremony — REQUIREMENTS + LATTICE-PIN + audit-doc closure). D-04 verdict per 08-RESEARCH Section 2 = NO Lattice-side carve-out; INV-06 frozen at e95067bfa87ed1b75838fc3b3ef217a3b01acbd3.

Plans:
- [ ] 08-01-PLAN.md (W0) — SW-side extension/ai/lattice-step-emitter.js producer (~80 lines dual-export idiom) + extension/background.js importScripts wire at line 13 (alphabetical between lattice-provider-bridge.js and ai-integration.js) + tests/lattice-step-emitter-smoke.test.js Wave 0 scaffold (Parts 1+2 filled; >= 12 PASS) + package.json scripts.test chain append. Closes audit gap G1 producer side. FINT-10.
