...
### WR-02 (medium): T1a head path classifies with `expectedShape` unavailable, so the only rot signals on the bundled-head tier are status/redirect/fetch-failed
