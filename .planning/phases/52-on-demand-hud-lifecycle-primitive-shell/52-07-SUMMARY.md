...
- `.planning/phases/52-on-demand-hud-lifecycle-primitive-shell/52-07-SUMMARY.md` — Records the browser and resource evidence without converting deferred live UAT into approval.
