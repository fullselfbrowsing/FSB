...
- `.planning/REQUIREMENTS.md` — Normative definitions for HUD-01 through HUD-05, HUD-07, and HUD-08.
- `.planning/PROJECT.md` — v1.2.0 milestone framing, platform constraints, and approved Skopeo decisions.

### Product and risk research
- `.planning/research/FEATURES.md` — On-demand behavior, shared primitive grammar, attention-budget matrix, host-integrity expectations, and explicit anti-features.
- `.planning/research/PITFALLS.md` — Teardown, host-page integrity, accessibility, stale-render, and overlay-resilience risks and release checks.
- `.planning/research/SUMMARY.md` — Milestone architecture sequence and lifecycle-first recommendation.
