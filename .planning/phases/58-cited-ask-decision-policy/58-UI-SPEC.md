...
| `REQUIREMENTS.md` | VIEW-06/07 and POLICY-01/02/03; answers use only accessible evidence, expose citations/conflicts/gaps/abstention, and enforce Document 10 and rare human-memo safeguards |
