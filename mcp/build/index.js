...
const DOCTOR_COMPATIBILITY_LABELS = {
    supported: 'Supported',
    degraded: 'Degraded',
    unsupported: 'Unsupported',
};
const DOCTOR_NATIVE_INSTALL_LABELS = {
    installed: 'Installed',
    not_installed: 'Not installed',
    invalid: 'Invalid',
    unavailable: 'Unavailable',
};
const DOCTOR_NATIVE_REGISTRATION_LABELS = {
    valid: 'Valid',
    missing: 'Missing',
    invalid: 'Invalid',
    unavailable: 'Unavailable',
};
const DOCTOR_NATIVE_ALLOWLIST_LABELS = {
    matches: 'Matches',
    mismatch: 'Mismatch',
    not_reported: 'Not reported',
};
const DOCTOR_NATIVE_LAUNCHER_LABELS = {
    reachable: 'Reachable',
    missing: 'Missing',
    invalid: 'Invalid',
    unavailable: 'Unavailable',
};
const DOCTOR_NATIVE_DAEMON_LABELS = {
    reachable: 'Reachable',
    offline: 'Offline',
    unavailable: 'Unavailable',
};
function formatDoctorTimestamp(timestamp) {
    if (timestamp === null)
        return 'Not reported';
...
export function formatDoctor(diagnostics) {
    ...
    for (const adapter of diagnostics.adapterDiagnostics) {
        const contract = diagnostics.compatibilityMatrix.adapters.find((candidate) => candidate.adapterId === adapter.adapterId);
