...
export const HANDLER_BY_APP = Object.freeze({
  ...
  wikipedia: 'wikipedia.js',
  hackernews: 'hackernews.js',
  reddit: 'reddit.js',
  yelp: 'yelp.js',
  tripadvisor: 'tripadvisor.js',
  zillow: 'zillow.js',
  redfin: 'redfin.js',
  bsky: 'bsky.js',
  mastodon: 'mastodon.js',
  meticulous: 'meticulous.js',
  stripe: 'stripe.js',
  ...
  stubhub: 'stubhub.js',
  kayak: 'kayak.js',
  opentable: 'opentable.js',
  mongodb: 'mongodb.js',
  snowflake: 'snowflake.js',
  cockroachdb: 'cockroachdb.js',
  clickhouse: 'clickhouse.js',
  temporal: 'temporal.js',
  msword: 'msword.js',
  excel: 'excel.js',
  pinterest: 'pinterest.js',
  starbucks: 'starbucks.js',
  medium: 'medium.js',
  dominos: 'dominos.js',
  ...
  posthog: 'posthog.js',
  datadog: 'datadog.js',
  chipotle: 'chipotle.js',
  pandaexpress: 'pandaexpress.js',
  grubhub: 'grubhub.js',
  costco: 'costco.js',
  instacart: 'instacart.js',
  ...
  etsy: 'etsy.js',
  fiverr: 'fiverr.js',
  homedepot: 'homedepot.js',
  hack2hire: 'hack2hire.js',
  chatgpt: 'chatgpt.js',
  claude: 'claude.js',
  gemini: 'gemini.js',
  minimax: 'minimax.js',
  ganalytics: 'ganalytics.js',
  figma: 'figma.js',
  gdrive: 'gdrive.js',
  gdocs: 'gdocs.js',
  ...
  webflow: 'webflow.js',
  ynab: 'ynab.js',
  calendly: 'calendly.js',
  dockerhub: 'dockerhub.js',
  tinder: 'tinder.js',
  craigslist: 'craigslist.js',
  sentry: 'sentry.js',
  supabase: 'supabase.js',
  shopify: 'shopify.js',
  gcal: 'gcal.js',
  gmaps: 'gmaps.js',
  notebooklm: 'notebooklm.js',
  eventbrite: 'eventbrite.js',
  ticketmaster: 'ticketmaster.js',
  zendesk: 'zendesk.js',
  spotify: 'spotify.js',
  twitch: 'twitch.js',
  steam: 'steam.js',
...
export async function validateCurrentT1PortGate(catalog, opts = {}) {
  ...
  const guardedRows = rows.filter(function(row) {
    return row && row.readiness === 't1-guarded-fail-closed' && isWriteLike(row.sideEffectClass);
  });
