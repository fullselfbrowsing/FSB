...
export const placeOrder = defineTool({
  ...
  description:
    'Place a paid Best Buy order: submit a cart of products for shipping or in-store pickup. This charges your saved payment method and commits the order -- a real money-moving action.',
  summary: 'order this on bestbuy',
  icon: 'shopping-cart',
  group: 'Orders',
  input: z.object({
    items: z.array(z.object({
      product_id: z.string().describe('Product SKU/ID'),
