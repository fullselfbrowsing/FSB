...
export const listRestaurants = defineTool({
  ...
  description:
    'List or search Grubhub restaurants available for delivery to an address. Optionally filter by a search term (cuisine or restaurant name).',
  summary: 'show me restaurants on grubhub',
  icon: 'utensils',
  group: 'Restaurants',
  input: z.object({
