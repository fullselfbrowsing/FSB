...
export const placeOrder = defineTool({
  ...
  description:
    'Place a paid Grubhub order: submit a cart of items from a restaurant to a delivery address. This charges your saved payment method and dispatches the order -- a real money-moving action.',
  summary: 'order food on grubhub',
  icon: 'shopping-cart',
  group: 'Orders',
  input: z.object({
