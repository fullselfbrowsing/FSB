...
export const placeOrder = defineTool({
  ...
  description:
    'Place a paid Amazon order: submit a cart of products to a shipping address. This charges your saved payment method and dispatches the order -- a real money-moving action.',
  summary: 'order this on amazon',
  icon: 'shopping-cart',
  group: 'Orders',
  input: z.object({
    items: z.array(z.object({
      product_id: z.string().describe('Product ASIN/ID'),
