...
export const searchFlights = defineTool({
  ...
  description:
    'Search Expedia for flights between an origin and destination on given dates. Returns matching flight itineraries with fares.',
  summary: 'search flights on expedia',
  icon: 'plane',
  group: 'Flights',
  input: z.object({
  ...
  output: z.object({
    flights: z.array(z.object({
      ...
      carrier: z.string(),
      fare: z.number(),
    })).describe('Matching flight itineraries'),
  }),
